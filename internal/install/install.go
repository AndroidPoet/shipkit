...
var Tools = []Tool{
	{Name: "Google Play Console CLI", Executable: "gpc", BrewFormula: "AndroidPoet/tap/playconsole-cli", InstallURL: "https://github.com/AndroidPoet/playconsole-cli"},
	{Name: "RevenueCat CLI", Executable: "rc", BrewFormula: "AndroidPoet/tap/revenuecat-cli", InstallURL: "https://github.com/AndroidPoet/revenuecat-cli"},
	{Name: "App Store Connect CLI", Executable: "asc", BrewFormula: "rorkai/tap/app-store-connect-cli", InstallURL: "https://github.com/rorkai/App-Store-Connect-CLI"},
}
